...
# Resolve the service account key using an absolute path relative to this
# file so the client works regardless of the process working directory.
# serviceAccountKey.json lives one level up in backend/
